...
import time, functions, classes, scenes
...
def intro101():
    ...
    # # functions.slow_print('Du versuchst, deine Augen zu öffnen, ')
    # # functions.slow_print('aber ein stechender Schmerz hält dich davon ab...')
